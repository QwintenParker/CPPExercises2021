...
void test(std::string name) {
    ...
    std::string resultsDir = "lesson09/resultsData/";
    ...
    cv::imwrite("lesson09/resultsData/" + name + "_1_2_houghSpace.png", hough);
    ...
    cv::imwrite("lesson09/resultsData/" + name + "_2_hough_normalized.png", houghAcc);
    ...
    int radius = 5;
    cv::Mat houghWithCircles = drawCirclesOnExtremumsInHoughSpace(houghAcc, lines, radius);
